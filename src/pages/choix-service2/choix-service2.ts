...
/**
 * Generated class for the ChoixService2Page page.
 *
...
@IonicPage()
@Component({
  selector: 'page-choix-service2',
  templateUrl: 'choix-service2.html',
})
export class ChoixService2Page {
  ...
  goToPrendreTicket() {
    this.navCtrl.push('PrendreTicket2Page', {service: this.service, agence: this.agence, photoURL: this.photoURL, url: this.url})
      .then(() => {

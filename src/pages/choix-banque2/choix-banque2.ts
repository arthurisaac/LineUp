...
/**
 * Generated class for the ChoixBanque2Page page.
 *
...
@IonicPage()
@Component({
  selector: 'page-choix-banque2',
  templateUrl: 'choix-banque2.html',
})
export class ChoixBanque2Page {
  notif = false;
  ...
  goToChoixAgence(x) {
    this.navCtrl.push('ChoixAgence2Page', {agence: x.agence, photoURL: x.photoURL});
  }

...
/**
 * Generated class for the ChoixAgencePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-choix-agence',
  templateUrl: 'choix-agence.html',
})
export class ChoixAgencePage {
  agences = [];
  locations = [];
  photoURL: string;
  ...
  goToChoixService(agence) {
    if (agence.url == null) {
      ...
      this.navCtrl.push('ChoixServicePage', {agence: agence, photoURL: this.photoURL});
    }
  }
